...
- Ability to configure custom group names for metrics. By default, metrics are created under the `rails` group. It is now possible to configure a custom group name for the metrics.
