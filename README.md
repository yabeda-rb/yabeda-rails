...
Configuration is handled by [anyway_config](https://github.com/palkan/anyway_config) gem. With it you can load settings from environment variables (upcased and prefixed with `YABEDA_RAILS_`), YAML files, and other sources. See [anyway_config](https://github.com/palkan/anyway_config) docs for details.

| Config key             | Type           | Default                                                          | Description                                                                                                                                                                                                                                                                                                      |
|------------------------|----------------|------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `apdex_target`         | integer        | nil                                                              | Tolerable time for Apdex in seconds, exposed as gauge if set.                                                                                                                                                                                                                                                    |
| `buckets`              | array of float | [000.5, 0.1, 0.5, 1, ...](./blob/master/lib/yabeda/rails.rb#L13) | A list of buckets used by histogram metrics.                                                                                                                                                                                                                                                                     |
| `controller_name_case` | symbol         | :snake                                                           | Defines whether controller name is reported in camel case (:camel) or snake case (:snake).                                                                                                                                                                                                                       |
| `group_name`           | symbol         | :rails                                                           | Defines the namespace for metric groups. By default, `:rails` will create metrics named `rails_requests_total`. Using `:custom_name` will create `custom_name_requests_total`.                                                                                                                                   |
